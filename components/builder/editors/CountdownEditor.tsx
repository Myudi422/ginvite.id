...
import { Field, FieldGroup, Input, ColorInput, Select, Toggle } from '../ui/EditorFields';
  ...
  return (
    <div className="p-4 space-y-3">
      ...
      <div className="space-y-2">
        {renderHeader('text', 'Teks & Waktu', Type)}
        {openGroups.text && (
          <div className="p-3 bg-white border border-gray-100 rounded-2xl space-y-4 shadow-sm">
            ...
            <Field label="Template Layout Hitung Mundur">
              <Select
                value={(props.layout_template as string) || 'classic'}
                onChange={v => set('layout_template', v)}
                options={[
                  { value: 'classic', label: 'Classic Rounded Cards' },
                  { value: 'modern_square', label: 'Modern Flat Squares' },
                  { value: 'glass_cards', label: 'Glassmorphism Floating' },
                  { value: 'neo_brutalism', label: 'Neo-Brutalism Outline' },
                  { value: 'minimal_split', label: 'Minimalist Colon Separators' },
                  { value: 'circular_ring', label: 'Circular Ring Borders' },
                  { value: 'grid_2x2', label: 'Compact Glass Grid (2x2)' },
                  { value: 'inline_bar', label: 'Minimalist Inline Bar' },
                  { value: 'title_bottom', label: 'Reversed (Countdown on Top)' },
                  { value: 'split_editorial', label: 'Split Magazine Column' },
                ]}
              />
            </Field>
