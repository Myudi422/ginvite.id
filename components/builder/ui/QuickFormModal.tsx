  ...
  return (
    <div className="fixed inset-0 z-50 bg-black/60 backdrop-blur-md flex items-center justify-center p-3 sm:p-4 animate-fade-in">
      <div className="bg-white rounded-3xl shadow-2xl w-full max-w-4xl h-[95vh] sm:h-[88vh] flex flex-col overflow-hidden border border-gray-100 animate-zoom-in">
        ...
        {/* Header */}
        <div className="px-6 py-4 border-b border-gray-100 flex items-center justify-between bg-gradient-to-r from-pink-50/50 via-rose-50/30 to-purple-50/50 flex-shrink-0">
          <div className="flex items-center gap-2.5">
            ...
            <div>
              <h2 className="text-sm font-bold text-gray-800">Isi Formulir Kilat Undangan</h2>
              <p className="text-[10px] text-gray-400 font-semibold">Tulis semua data utama dalam satu formulir untuk menyederhanakan pembuatan undangan.</p>
            </div>
          </div>
          <button 
            onClick={onClose} 
            className="p-2 rounded-full border border-gray-100 text-gray-400 hover:text-gray-700 hover:bg-gray-50 active:scale-95 transition-all"
          >
        ...
        {/* Tab Selector */}
        <div className="flex border-b border-gray-100 bg-gray-50/50 p-2 gap-1.5 flex-shrink-0 overflow-x-auto no-scrollbar">
          <button
        ...
        {/* Content Body */}
        <div className="flex-1 overflow-y-auto p-6 min-h-0 bg-gray-50/20 custom-scrollbar">
          
          {/* TAB 1: GENERAL */}
          {activeTab === 'general' && (
            <div className="max-w-2xl mx-auto space-y-6">
              <div className="p-4 bg-pink-50/30 border border-pink-100 rounded-2xl flex gap-3">
              ...
              <div className="space-y-4 bg-white p-6 border border-gray-100 rounded-2xl shadow-sm">
                <div>
            ...
            <div className="max-w-3xl mx-auto space-y-6">
              {page.event_type === 'pernikahan' ? (
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  {/* Groom Form */}
                  <div className="bg-white p-6 border border-gray-100 rounded-2xl shadow-sm space-y-4 relative">
                ...
                <div className="bg-white p-6 border border-gray-100 rounded-2xl shadow-sm space-y-4 max-w-2xl mx-auto">
                  <div className="pb-3 border-b border-gray-100 flex items-center gap-2">
                    <span className="text-lg">👤</span>
        ...
        <div className="px-6 py-4 border-t border-gray-100 flex items-center justify-between bg-gray-50 flex-shrink-0">
          {saveError ? (
            <p className="text-[10px] text-red-500 font-bold flex items-center gap-1 max-w-[50%] truncate" title={saveError}>
          ...
          <div className="flex gap-2">
            <button
              onClick={onClose}
              disabled={saving}
              className="px-4 py-2 border border-gray-200 text-xs font-bold text-gray-600 rounded-xl hover:bg-gray-100 transition-colors active:scale-95 disabled:opacity-50"
            >
              Batal
            </button>
            <button
              ...
              disabled={saving}
              className="px-4 py-2 border border-pink-200 bg-pink-50 hover:bg-pink-100/50 text-xs font-bold text-pink-700 rounded-xl transition-colors active:scale-95 disabled:opacity-50"
            >
              Terapkan ke Canvas
            </button>
            <button
              ...
              disabled={saving}
              className="px-5 py-2 bg-gradient-to-r from-pink-500 to-rose-500 hover:from-pink-600 hover:to-rose-600 text-xs font-extrabold text-white rounded-xl shadow-md active:scale-95 transition-all flex items-center gap-1.5 disabled:opacity-50"
            >
              {saving ? (
                <>
