        ...
        >
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-4">
            <button
              ...
              className="inline-flex items-center justify-center gap-2.5 bg-white text-rose-600 hover:text-rose-700 hover:bg-rose-50 font-bold rounded-full px-8 py-4 text-base shadow-xl shadow-pink-950/25 hover:-translate-y-0.5 active:translate-y-0 transition-all duration-200"
            >
            ...
            <button
              ...
              className="inline-flex items-center justify-center gap-2 border-2 border-white/30 text-white hover:bg-white/10 hover:border-white/60 rounded-full px-8 py-4 text-base font-bold hover:-translate-y-0.5 active:translate-y-0 transition-all duration-200"
            >
              <span>💌 Buat Undangan Digital Gratis</span>
            </button>
          </div>
        </motion.div>
      </div>
