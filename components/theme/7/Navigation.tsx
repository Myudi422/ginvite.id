              ...
              return (
                <button
                  ...
                  className={cn(
                    ...
                    isActive ? "text-[var(--t7-text-primary)]" : "text-zinc-400 hover:text-zinc-600"
                  )}
                >
                  <item.icon
                    size={20}
                  ...
                  {isActive && (
                    <span className="absolute -bottom-1 w-1 h-1 bg-[var(--t7-text-primary)] rounded-full shadow-sm" />
                  )}
                </button>
              );
            })}
