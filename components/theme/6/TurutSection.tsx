  ...
  return (
    <ThemeSection className="bg-white mx-4 rounded-3xl p-6 border border-black/5 shadow-xl mt-12 mb-12">
      <div className="flex flex-col items-center gap-2 mb-6 text-center">
        <div className="w-12 h-12 rounded-full border border-[var(--t6-border-glass)] flex items-center justify-center mb-2 bg-[var(--t6-bg-main)]">
          <span className="text-xl">🤍</span>
        </div>
        <ThemeHeader size="lg" className="text-[var(--t6-text-primary)] font-bold">Turut Mengundang</ThemeHeader>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
        {list.map((item, idx) => (
          ...
          >
            {/* Avatar */}
            <div className="w-8 h-8 rounded-full flex items-center justify-center text-white text-xs font-bold shadow-sm bg-[var(--t6-text-primary)]">
