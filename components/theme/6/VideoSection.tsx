                    ...
                    >
                        {thumbnail ? (
                            <div className="absolute inset-0">
                                <Image unoptimized={true} src={thumbnail} alt="video preview" fill sizes="(max-width: 768px) 100vw, 50vw" className="object-cover opacity-80 group-hover:scale-105 transition-transform duration-700" />
                            </div>
                        ) : (
                        ...
                        <div className="absolute inset-0 flex items-center justify-center">
                            <div className="w-20 h-20 rounded-full bg-white/90 shadow-lg flex items-center justify-center flex-col gap-1 text-[var(--t6-text-primary)] group-hover:scale-110 transition-all duration-300 pointer-events-none">
