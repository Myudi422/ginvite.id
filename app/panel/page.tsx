...
import { UserIcon, CreditCardIcon, MailIcon, RefreshCw } from "lucide-react";
...
export default function PanelPage() {
  ...
  // c) State untuk kategori grafik & tab aktif
  ...
  // =========================================================================
  // 2. useEffect → Fetch data dari analis.php setiap kali startDate, endDate atau refreshTrigger berubah
  // =========================================================================
  useEffect(() => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-pink-50 via-rose-50 to-purple-50 p-4 md:p-8 max-w-full overflow-x-hidden">
      {/* ============================
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-8 space-y-4 sm:space-y-0">
        ...
        <div>
          ...
          <p className="text-sm text-pink-600 mt-1">
            Pantau dan kelola seluruh statistik undangan
          </p>
        </div>
        ...
        <Button
          ...
          variant="outline"
          className="w-fit flex items-center gap-2 px-5 py-2.5 border-pink-200 bg-white hover:bg-pink-50 text-pink-700 rounded-xl shadow-sm transition-all active:scale-[0.98]"
        >
      ...
      {/* ============================
          TABS SWITCHER
         ============================ */}
      <div className="flex bg-pink-100/50 p-1 rounded-2xl w-full sm:w-fit mb-8 border border-pink-100/80">
        <button
          onClick={() => setActiveTab("stats")}
          className={`flex-1 sm:flex-none px-2 sm:px-6 py-2 rounded-xl text-xs sm:text-sm font-bold transition-all duration-200 cursor-pointer text-center ${
            activeTab === "stats"
      ...
      {activeTab === "stats" ? (
        <div className="space-y-8 animate-in fade-in slide-in-from-bottom-2 duration-300">
          ...
          <div className="flex flex-col sm:flex-row sm:items-end sm:space-x-4 space-y-4 sm:space-y-0 w-full bg-white/60 p-5 rounded-2xl shadow-sm border border-pink-100">
            {/* Start Date Picker */}
            <div className="flex flex-col w-full sm:w-auto">
              <label htmlFor="startDatePicker" className="text-pink-700 text-xs font-semibold mb-1.5 uppercase tracking-wider">
                Tanggal Mulai
              </label>
              <Popover>
                <PopoverTrigger asChild>
                  <Button
                    id="startDatePicker"
                    variant="outline"
                    className="w-full sm:w-44 justify-between px-4 py-2 text-left text-pink-700 border-pink-200 bg-white hover:bg-pink-50 rounded-xl focus:ring-2 focus:ring-pink-300 transition-colors"
                  >
            ...
            {/* End Date Picker */}
            <div className="flex flex-col w-full sm:w-auto">
              <label htmlFor="endDatePicker" className="text-pink-700 text-xs font-semibold mb-1.5 uppercase tracking-wider">
                Tanggal Akhir
              </label>
              <Popover>
                <PopoverTrigger asChild>
            ...
            {/* Category Select */}
            <div className="flex flex-col w-full sm:w-auto">
              <label htmlFor="category" className="text-pink-700 text-xs font-semibold mb-1.5 uppercase tracking-wider">
                Kategori Grafik
              </label>
              <select
                id="category"
                ...
                className="w-full sm:w-44 px-4 py-2 border border-pink-200 bg-white rounded-xl focus:outline-none focus:ring-2 focus:ring-pink-300 text-pink-700 transition-colors appearance-none"
              >
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
            {/* Total User */}
            <div className="rounded-2xl p-5 text-white bg-gradient-to-br from-pink-500 to-rose-500 shadow-md transform transition duration-300 hover:-translate-y-1 hover:shadow-lg">
            ...
            {/* Pendapatan */}
            <div className="rounded-2xl p-5 text-white bg-gradient-to-br from-violet-500 to-purple-500 shadow-md transform transition duration-300 hover:-translate-y-1 hover:shadow-lg">
              <div className="bg-white/20 rounded-xl p-3 w-fit mb-3">
            ...
            {/* Undangan */}
            <div className="rounded-2xl p-5 text-white bg-gradient-to-br from-emerald-400 to-teal-500 shadow-md transform transition duration-300 hover:-translate-y-1 hover:shadow-lg">
              <div className="bg-white/20 rounded-xl p-3 w-fit mb-3">
          ...
          {/* CHART (Recharts) */}
          <div className="bg-white rounded-3xl p-5 md:p-8 shadow-sm border border-pink-100 w-full overflow-hidden">
        ...
        /* List User Component (Tab Daftar Undangan) */
        <div className="bg-white rounded-3xl p-4 sm:p-6 md:p-8 shadow-sm border border-pink-100 relative overflow-hidden animate-in fade-in slide-in-from-bottom-2 duration-300 w-full max-w-full">
