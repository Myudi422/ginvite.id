...
export default function UploadBlogForm({ onUploadSuccess }: UploadBlogFormProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const response = await axios.post(`${API_BASE}?action=create`, formData, {
      ...
      if (data.status === 'success') {
        if (data.blog_id && content) {
          await syncBlogImages(data.blog_id, content);
        }
        ...
        setMessage({ type: 'error', text: `Error: ${data.message || 'Gagal menyimpan artikel.'}` });
      }
    } catch {
              ...
              <div>
                ...
                <div className="flex items-center gap-2">
                  ...
                  <Input
                    ...
                    className="flex-1 text-slate-800 border-slate-200 focus:border-pink-400 font-mono text-sm"
                    required
                  />
                  <button
                    type="button"
          ...
          <div className="space-y-5">
            ...
            <div className="bg-white rounded-2xl border border-slate-100 shadow-sm p-6 space-y-4">
              ...
              <div>
                ...
                <Select onValueChange={(v) => setStatus(v)} value={status} defaultValue="draft">
              ...
              <div>
                ...
                <Select onValueChange={(v) => setCategory(v)} value={category} defaultValue="">
                  <SelectTrigger className="w-full border-slate-200">
            ...
            <div className="bg-white rounded-2xl border border-slate-100 shadow-sm p-6 space-y-4">
              ...
              >
                ...
                <p className="text-sm font-medium text-slate-500">Upload gambar thumbnail</p>
                <p className="text-xs text-slate-400 mt-1">Drag & drop atau klik untuk pilih</p>
