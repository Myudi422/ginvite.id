...
const links = [
    ...
    {
        id: "edit-photo",
        label: "Jasa Edit Photo",
        sub: "Ubah background & retouch Pro",
        href: `${WA_URL}?text=${encodeURIComponent("Halo Papunda, saya tertarik dengan jasa edit photo.")}`,
        external: true,
        icon: (
            <svg className="w-5 h-5 shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
    ...
    {
        id: "video-3d",
        label: "Undangan Video 3D Motion",
        sub: "Elegan, mewah & kekinian",
        href: `${WA_URL}?text=${encodeURIComponent("Halo Papunda, saya tertarik dengan jasa bikin undangan video 3D motion.")}`,
        external: true,
        icon: (
            <svg className="w-5 h-5 shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
